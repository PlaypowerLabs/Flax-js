...
flax.playSound = function (path) {
    if (window["ppPplHelpersLibAudioHelper"]) {
        ppPplHelpersLibAudioHelper.default.playAudioFromZip({}, path, "");
    }
    else if (window["ppPplHelpersLibAudioHelper"]) {
        ppLearnflowSdkLibHelpersAudioHelper.default.playAudioFromZip({}, path, "");
    } else {
        flax.playEffect(path);
    }
};
//----------------------sound about-------------------------------------------------------
